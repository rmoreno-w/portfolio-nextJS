            ...
            <Container>
                ...
                <div className='flex flex-col desktop:flex-row gap-8  sm:gap-12'>
                    ...
                    <article>
                        ...
                        <p>
                            Hmm, maybe not so much. I believe that we should have a purpose for coding. When I got into
                            web development I was learning how to code but that was it, I knew how to put div’s in
                            place.
                        </p>
                        ...
                        <p>
                            ...
                            div’s. How could I express what I wanted in a more meaningful way? How could I make it
                            easier for someone to understand what was written? How could I make the visuals more
                            appealing?
                        </p>
                        ...
                        <p>
                            ...
                            <span className='font-bold'>UI</span>, as they play a big role when solving these questions.
                            And while working with this magic mix between <span className='font-bold'>design</span>,{' '}
                            <span className='font-bold'>technology</span> and <span className='font-bold'>people</span>{' '}
                            I feel that we can take every product or service to the next level. And that’s why I love
                            what I do!
                        </p>
                        ...
                        <p>
                            ...
                            streams, listening to some music (and air-drumming along), enjoying rainy days or even
                            thinking about what would I have for my next dessert.
                        </p>
